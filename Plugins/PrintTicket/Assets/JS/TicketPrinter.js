...
export function showPrinterDialog(documentName) {
	...
	fetch("PrintTicket", { method: "POST", body: data })
		...
		.catch((error) =>
			showPrintMessage("Error al obtener los formatos de impresion: " + error)
		);
}
...
function printRequest({ documentCode, documentFormat, documentName }) {
	...
	fetch("PrintTicket", { method: "POST", body: data })
		...
		.catch((error) =>
			showPrintMessage("No se pudo conectar al servicio de impresion: " + error)
		);
}
...
function buildModalContent(data, documentName) {
	// Assuming you have a function to build the HTML content for the modal
...
function buildModalHtml(data, documentName) {
    // Assuming you have a function to build the HTML content for the modal
    // You can use the template you provided in your question
    const template = `
    <style>
    ...
    <div id="ticketPrintingArea">
        ...
        // Use the template and data to build the HTML content
